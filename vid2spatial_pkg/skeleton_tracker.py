...
`vid2spatial_pkg.experimental.skeleton_tracker` instead.
"""
import warnings as _warnings

from .experimental.skeleton_tracker import *  # noqa: F401,F403
from .experimental import skeleton_tracker as _impl

_warnings.warn(
    "vid2spatial_pkg.skeleton_tracker moved to vid2spatial_pkg.experimental.skeleton_tracker "
