...
`vid2spatial_pkg.experimental.color_tracker` instead.
"""
import warnings as _warnings

from .experimental.color_tracker import *  # noqa: F401,F403
from .experimental import color_tracker as _impl

_warnings.warn(
    "vid2spatial_pkg.color_tracker moved to vid2spatial_pkg.experimental.color_tracker "
